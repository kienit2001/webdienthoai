...
public class ProductService {
    ...
    public Page<Product> listSearchProduct(String keyword, Integer pageNum, String radioPrice, String radioSort, String radioBrand) {
        double minPrice = 0;
        double maxPrice = 0;
        Pageable pageable = null;
        if(radioPrice != null) {
        ...
        if (keyword != null && !keyword.isEmpty()) {
            ...
            return productRepository.searchWithKeywordFilterProduct(keyword, minPrice, maxPrice, radioBrand, pageable);
        }

        return productRepository.searchFilterProduct(minPrice, maxPrice, radioBrand, pageable);
